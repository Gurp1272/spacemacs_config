...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(elixir
     ...
     erlang
     ;; elixir
     (use-package lsp-mode :commands lsp :ensure t, :diminish lsp-mode :hook (elixir-mode . lsp) :init (add-to-list 'exec-path "/data/Downloads/Browser\ Download/elixir-ls"))
